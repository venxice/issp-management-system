...
.cyber-item__icon.checked { color: #2b6cb0; }
...
.checklist-item__icon { width: 18px; text-align: center; font-size: .8rem; flex-shrink: 0; }
.checklist-item__icon.checked { color: #2b6cb0; }
.checklist-item__icon.unchecked { color: #c5ccd6; }
.checklist-item__label { font-size: .82rem; color: var(--ink); font-weight: 500; }
.checklist-item__label.unchecked { color: #8898aa; }
.checklist-item__text { font-size: .78rem; color: #536783; font-style: italic; margin-left: 4px; }
.checklist-count { font-weight: 400; color: #8898aa; font-size: .72rem; margin-left: 8px; }
</style>

<a href="<?= site_url('employee/submitted-ict-projects') ?>" class="btn-back">
...
<div class="project-hero">
    ...
    <div class="remarks-card">
        <div class="remarks-card__header">
            <i class="fa-solid fa-rotate-left"></i> DG Remarks
        </div>
...
<?php elseif ($key === 'network-infrastructure-form'): ?>
        ...
        function renderFields($fields, $sectionKey, $fieldLabels, $diagramField = null) {
            $diagramDone = false;
            foreach ($fields as $fieldName => $fieldValue):
                ...
                if ($diagramField && $fieldName === $diagramField) $diagramDone = true;
        ?>
        ...
        <div class="sub-header" style="margin-top:20px;padding-top:16px;border-top:2px solid #e8ecf1;">
            ...
            <span style="font-weight:400;text-transform:none;font-size:.74rem;color:var(--muted);margin-left:8px;"></span>
        </div>
